        ...
        <>
            <div>
                ...
                <div className="mt-6 flex gap-8">
                    <ButtonRoute name="Iniciante" type="Play" link="home/trilha/Iniciante" /> {/*Link modificado para comparar o nivel da rota */}
                    <ButtonRoute name="Intermediário" type="TestTube" link="home/trilha/Intermediário" />
                    <ButtonRoute name="Avançado" type="Medal" link="home/trilha/Avançado" />
                </div>
            </div>
